    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start" style="font-size:20px;font-weight:bold;color:blue">
            ...
            <div class="image" style="display: flex; justify-content: center; background-image: url('{{asset('image/universite2.jpg')}}'); background-size: cover; background-position: center;">
                <form action="{{ route('store')}}" method="post" style="width: 50%; background-color: rgba(255, 255, 255, 0.8); padding: 20px; border-radius: 10px;">
                    @csrf
                    @csrf
                    <div class="mb-3">
